...
local function find_binary()
    ...
    local skills_root = vulcan.path.join(get_skill_dir(), "..")
    local binary_directory = vulcan.path.join(skills_root, "__tools", "bin")
...
return function(args)
    ...
    if not binary_path then
        return {
            ...
            expected_path = vulcan.path.join(vulcan.path.join(get_skill_dir(), ".."), "__tools", "bin", executable_name),
        }
    end
