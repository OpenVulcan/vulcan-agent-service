...
return {
    initialize_ast_client_budget = initialize_ast_client_budget,
    build_ast_grep_ffi_library_candidates = build_ast_grep_ffi_library_candidates,
    validate_path_argument = validate_path_argument,
    validate_recursive_argument = validate_recursive_argument,
    validate_noignore_argument = validate_noignore_argument,
    validate_extension_argument = validate_extension_argument,
    validate_comment_argument = validate_comment_argument,
    validate_detail_paths_argument = validate_detail_paths_argument,
    validate_export_md_argument = validate_export_md_argument,
    classify_target_path_modes = classify_target_path_modes,
    collect_files = collect_files,
    find_binary = find_binary,
    run_language_scan = run_language_scan,
    run_inline_rule_scan = run_inline_rule_scan,
