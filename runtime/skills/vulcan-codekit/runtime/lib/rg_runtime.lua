...
--[[
执行一次完整的 RG + AST 关联分析，并返回最终 Markdown 结果。
Execute one full RG plus AST correlation analysis and return the final Markdown result.
]]
local function execute(args, helper_bundle)
...
return {
    initialize_rg_client_budget = initialize_rg_client_budget,
