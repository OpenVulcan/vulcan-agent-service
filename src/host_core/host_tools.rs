...
/// 构建运行时配置文件热重载宿主工具描述。
pub(super) fn reload_runtime_configs_tool() -> Tool {
...
pub(super) fn skill_manager_tool() -> Tool {
    Tool::with_annotations(
        "skill-manager",
...
pub(super) fn runtime_config_tool() -> Tool {
    Tool::with_annotations(
        "luaskill-config",
...
pub(super) fn lua_help_list_tool() -> Tool {
    Tool::with_annotations(
        "vulcan-help-list",
...
pub(super) fn lua_help_detail_tool() -> Tool {
    Tool::with_annotations(
        "vulcan-help-detail",
