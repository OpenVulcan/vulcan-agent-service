...
PY
        ...
        echo "Unsupported LUA_RUNTIME_VERSION value '${legacy_runtime_version}'. Use a semantic version such as 0.4.3, or set LUA_RUNTIME_PACKAGES_VERSION for an exact luaskills-packages tag." >&2
        return 1
    fi
