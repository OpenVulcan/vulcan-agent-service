...
function Resolve-LuaRuntimePackagesTag {
    ...
    try {
        ...
        throw "Unsupported LUA_RUNTIME_VERSION value '$LegacyRuntimeVersion'. Use a semantic version such as 0.3.1, or set LUA_RUNTIME_PACKAGES_VERSION for an exact luaskills-packages tag."
    }
